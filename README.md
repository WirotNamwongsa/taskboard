...
![CI](https://github.com/WirotNamwongsa/taskboard/actions/workflows/ci.yml/badge.svg)
![CD](https://github.com/WirotNamwongsa/taskboard/actions/workflows/cd.yml/badge.svg)
...
```bash
# Clone
git clone https://github.com/WirotNamwongsa/taskboard.git
cd taskboard
